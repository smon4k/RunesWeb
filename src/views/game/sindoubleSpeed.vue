        ...
        <div class="game">
            <el-row :gutter="20">
                ...
                <el-col :span="screenWidth < 1200 ? 24 : 14" align="center">
                    <List :game_type="3" @childUpdatePlatformBalance="childUpdatePlatformBalance" />
                </el-col>
...
export default {
    ...
    methods: {
        ...
        async getLusdBalance() {  //获取余额
            ...
            let dealerBalance = await getUserDealerBalance(3, 2);
        ...
        async saveAutoBetConfigData() { //自动下注 更新修改配置数据
            ...
            autoBetConfigArr[3] = autoBetConfigArrRes;
        ...
        async getAutoBetConfigData() { //获取自动投注配置数据
            ...
            if(autoBetConfig && autoBetConfig !== undefined) {
                ...
                if(autoBetConfigArr[3]) {
                    this.winningBet = autoBetConfigArr[3].winningBet;
                    this.lossBet = autoBetConfigArr[3].lossBet;
                    this.win_add_bet = autoBetConfigArr[3].win_add_bet;
                    this.win_minus_bet = autoBetConfigArr[3].win_minus_bet;
                    this.loss_add_bet = autoBetConfigArr[3].loss_add_bet;
                    this.loss_minus_bet = autoBetConfigArr[3].loss_minus_bet;
                    this.balance_lower = autoBetConfigArr[3].balance_lower;
                    this.maximum_bet = autoBetConfigArr[3].maximum_bet;
                    this.minimum_bet = autoBetConfigArr[3].minimum_bet;
                }
            }
        },
    },
