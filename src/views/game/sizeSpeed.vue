...
<template>
    <div class="container">
        <div class="game">
            <el-row :gutter="20">
                <el-col :span="screenWidth < 1200 ? 24 : 10" align="center">
                    <div class="bet-amount" style="text-align: left;">
                        <div>
                    ...
                    <div class="marginTop" :style="{width: screenWidth > 1200 ? '' : screenWidth < 600 ? '90%' : '60%'}">
                        ...
                        <!-- <el-button class="dealer" @click="likeDealer()">我要做庄家</el-button> -->
                        <el-button-group>
                        ...
                        <!-- 赌注 -->
                        <el-input placeholder="" :min="minBetNum" v-model="size" class="operate" @input="calcBetFun"></el-input>
                        ...
                        <div class="size">
                            <el-radio v-model="betting" label="大" border>{{ $t('game:Max') }}</el-radio>
                            <el-radio v-model="betting" label="小" border>{{ $t('game:Min') }}</el-radio>
                        </div>
                            ...
                            <el-col :span="screenWidth < 600 ? 24 : 12" align="left">
                                <div class="auto-mode">
                                    ...
                                    <el-radio-group v-model="winningBet" size="small">
                                        ...
                                        <el-input placeholder="" type="number" v-model="win_add_bet" max="98" class="operate increase-bet-input" @input="calcBetFun">
                                            <template slot="append">%</template>
                                        </el-input>

                                        <el-radio label="3" border class="increase-bet-radio">{{ $t('game:decreaseBet') }}</el-radio>
                                        <el-input placeholder="" type="number" v-model="win_minus_bet" max="98" class="operate increase-bet-input" @input="calcBetFun">
                                            <template slot="append">%</template>
                                        </el-input>
                                    </el-radio-group>
                                </div>
                            ...
                            <el-col :span="screenWidth < 600 ? 24 : 12" align="left">
                                <div class="auto-mode">
                                    ...
                                    <el-radio-group v-model="lossBet" size="small">
                                        ...
                                        <el-radio label="2" border class="increase-bet-radio">{{ $t('game:increaseBet') }}</el-radio>
                                        <el-input placeholder="" type="number" v-model="loss_add_bet" max="98" class="operate increase-bet-input" @input="calcBetFun">
                                            <template slot="append">%</template>
                                        </el-input>

                                        <el-radio label="3" border class="increase-bet-radio">{{ $t('game:decreaseBet') }}</el-radio>
                                        <el-input placeholder="" type="number" v-model="loss_minus_bet" max="98" class="operate increase-bet-input" @input="calcBetFun">
                                            <template slot="append">%</template>
                                        </el-input>
                                    </el-radio-group>
                                </div>
                        ...
                        <!-- <el-button class="start-bet dealer" @click="likeDealer()">庄家</el-button> -->
                        <br><br>
                        <el-alert
                            v-show="alertShow"
                            class="alert"
                ...
                <el-col :span="screenWidth < 1200 ? 24 : 14" align="center">
                    <List :game_type="2" @childUpdatePlatformBalance="childUpdatePlatformBalance" />
                </el-col>
                    ...
                    <div class="rule" :style="{width: screenWidth < 600 ? '100%' : '100%', marginTop: screenWidth < 600 ? '30px' : '30px'}">
                        ...
                        <div class="box">
                            <span>
                                普通大小玩法介绍：（2倍赔率）<br>
                                A.使用OKT兑换好LUSD <br>
                                B.向游戏地址投注LUSD，向游戏地址投注资金（尾数为0.00代表下注小、尾数为其他代表下注大） <br>
                                C.投注数额等于转账数额 <br>
        ...
        <!-- <el-alert
            ...
            :center="false"
            effect="dark"
            :style="{width: screenWidth < 600 ? '80%' : '20%'}">
        </el-alert> -->
    </div>
</template>
<script>
...
export default {
    ...
    computed: {
        ...mapState({
            ...
            gamesFillingAddress:state=>state.base.sizeAddress,
    ...
    methods: {
        ...
        async getLusdBalance() {  //获取余额
            ...
            let dealerBalance = await getUserDealerBalance(2, 2);
            this.dealerTotalBalance = dealerBalance.total_balance; //获取庄家总余额
        },
        async childUpdatePlatformBalance() { //接受子组件更新平台余额
        ...
        async saveAutoBetConfigData() { //自动下注 更新修改配置数据
            ...
            autoBetConfigArr[2] = autoBetConfigArrRes;
        ...
        async getAutoBetConfigData() { //获取自动投注配置数据
            ...
            if(autoBetConfig && autoBetConfig !== undefined) {
                ...
                if(autoBetConfigArr[2]) {
                    this.winningBet = autoBetConfigArr[2].winningBet;
                    this.lossBet = autoBetConfigArr[2].lossBet;
                    this.win_add_bet = autoBetConfigArr[2].win_add_bet;
                    this.win_minus_bet = autoBetConfigArr[2].win_minus_bet;
                    this.loss_add_bet = autoBetConfigArr[2].loss_add_bet;
                    this.loss_minus_bet = autoBetConfigArr[2].loss_minus_bet;
                    this.balance_lower = autoBetConfigArr[2].balance_lower;
                    this.maximum_bet = autoBetConfigArr[2].maximum_bet;
                    this.minimum_bet = autoBetConfigArr[2].minimum_bet;
                }
            }
        },
    },
