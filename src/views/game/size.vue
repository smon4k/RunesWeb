...
export default {
    ...
    methods: {
        ...
        startPlaceBet() { //开始下注
            ...
            let maxBetAmount = Number(this.dealerTotalBalance) * 0.01; //下注最大利润
                ...
                if(result) {
                    ...
                    if(index) {
                        ...
                        if(result_value >= 0 && result_value < 10) {
                            if(result_value <= 4) { // 01234 开牌结果 小
                                lost = this.betting === '小' ? 1 : 0;
                            }
                            if(result_value >= 5 && result_value <= 9) { // 56789 开牌结果 大
                                lost = this.betting === '大' ? 1 : 0;
                            }
