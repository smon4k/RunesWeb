    ...
    <div class="container">
        <div class="commin-title">
            <div class="title-inner">
                <span class="tit">{{ $t('public:language') == 'zh' ? '质押GLS获取LUSD收益' : 'Pledge GLS to obtain LUSD income' }}</span>
        ...
        <div v-if="!isMobel">
            <el-table
                ...
                <el-table-column
                    ...
                    width="">
                    <template slot-scope="scope">
                        <span>{{ toFixed(Number(scope.row.balance), 4) }}</span>
                ...
                <el-table-column
                    ...
                    width="">
                    <template slot-scope="scope">
                        <span>{{ toFixed(Number(scope.row.reward), 4) }} LUSD</span>
                    </template>
                </el-table-column>
                <!-- 操作 -->
                <el-table-column
...
export default {
    ...
    computed: {
        ...mapState({
            ...
            poolsList: (state) => state.base.poolsList,
        }),
